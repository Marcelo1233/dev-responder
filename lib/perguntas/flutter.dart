                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 35, 0, 236),
                  ...
                  for (int i = 0; i < questionsf[index].answers!.length; i++)
                    ...
                    Container(
                      ...
                      child: RawMaterialButton(
                        ...
                        fillColor: btnPressed
                            ? questionsf[index].answers!.values.toList()[i]
                                ? Colors.green
                                : Colors.red
                        ...
                        onPressed: !answered
                            ...
                            : null,
                        child: Text(questionsf[index].answers!.keys.toList()[i],
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 18.0,
                  ...
                  RawMaterialButton(
                    onPressed: () {
                      if (_controller!.page?.toInt() == questionsf.length - 1) {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
